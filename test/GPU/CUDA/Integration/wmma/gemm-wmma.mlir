...
module attributes {gpu.container_module} {
  func.func @entry(%arg0: memref<16x16xf16>, %arg1: memref<16x16xf16>, %arg2: memref<16x16xf16>) {
    ...
    %tOut = gpu.memcpy async %out, %arg2 : memref<16x16xf16>, memref<16x16xf16>
    gpu.wait [%tOut]
    %vcst = arith.constant -1.000000e+00 : f16
    %v0 = vector.transfer_read %out[%c0, %c0], %vcst : memref<16x16xf16>, vector<16x16xf16>
...
// CHECK-COUNT-16: ( 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17 )
