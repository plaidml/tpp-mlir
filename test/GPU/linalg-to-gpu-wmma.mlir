...
func.func @batch_reduce_matmul(%arg0: memref<32x16x16xf16>,
                 %arg1: memref<32x16x16xf16>,
                 %arg2: memref<16x16xf16>) {
  linalg.batch_reduce_matmul  ins(%arg0, %arg1 : memref<32x16x16xf16>, memref<32x16x16xf16>)
                              outs(%arg2 : memref<16x16xf16>)
  return
}
...
// CHECK-SAME:  %[[A:.+]]: memref<32x16x16xf16>, %[[B:.+]]: memref<32x16x16xf16>, %[[C:.+]]: memref<16x16xf16>
