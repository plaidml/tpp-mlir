// RUN: standalone-opt %s -split-input-file -linalg-bufferize -func-bufferize -map-linalg-to-tpp -convert-linalg-to-tpp | FileCheck %s

// RUN: standalone-opt %s -split-input-file -map-linalg-to-tpp -linalg-bufferize -func-bufferize -convert-linalg-to-tpp | FileCheck %s
