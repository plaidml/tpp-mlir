...
// CHECK-SAME:  %[[ARG0:[a-zA-Z0-9]+]]: memref<256x512xf32>,
// CHECK-SAME:  %[[ARG1:[a-zA-Z0-9]+]]: memref<512x1024xf32>,
// CHECK-SAME:  %[[ARG2:[a-zA-Z0-9]+]]: memref<256x1024xf32>,
// CHECK-SAME:  %[[ARG3:[a-zA-Z0-9]+]]: memref<1024xf32>) {
// CHECK-DAG: %[[C0:.+]] = arith.constant 0 : index
// CHECK-DAG: %[[C8:.+]] = arith.constant 8 : index
// CHECK-DAG: %[[C1:.+]] = arith.constant 1 : index
// CHECK-DAG: %[[C32:.+]] = arith.constant 32 : index
// CHECK: tpp.identity ins(%[[ARG3]] : memref<1024xf32>) out(%[[ARG2]] : memref<256x1024xf32>)
...
// CHECK:   scf.yield
// CHECK: }
// CHECK: linalgx.unpack %[[ALLOC2]] inner_dims_pos = [0, 1] inner_tiles = [32, 32] into %[[ARG2]] : (memref<8x32x32x32xf32> memref<256x1024xf32>)
