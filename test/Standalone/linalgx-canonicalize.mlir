...
// CHECK-LABEL: @attensor(
// CHECK-SAME: %[[arg0:.*]]: tensor<128x512xf32>
func.func @attensor(%arg0: tensor<128x512xf32>) -> tensor<128x512xf32> {
...
// CHECK-LABEL: @atmemref(
func.func @atmemref(%arg0: memref<128x512xf32>) -> memref<128x512xf32> {
