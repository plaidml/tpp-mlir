...
module @predict_function {
  ...
  func.func @main(%arg0: tensor<1x224x224x3xf32>, %arg1: tensor<7x7x3x64xf32> {stdx.const}, %arg2: tensor<64xf32> {stdx.const}, %arg3: tensor<1x1x64x256xf32> {stdx.const}, %arg4: tensor<256xf32> {stdx.const}, %arg5: tensor<3x3x64x256xf32> {stdx.const}, %arg6: tensor<256xf32> {stdx.const}) -> tensor<1x56x56x256xf32> {
