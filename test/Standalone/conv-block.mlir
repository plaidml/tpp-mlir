...
func.func @conv(%i: tensor<14x512x28x28xf32>, %f: tensor<1024x512x1x1xf32>, 
  ...
  // CHECK: %[[img:.*]] = tensor.empty() : tensor<14x16x28x28x32xf32>
  // CHECK-NEXT: %[[img_relayout:.*]] = linalgx.relayout
  // CHECK-NEXT: %[[filt:.*]] = tensor.empty() : tensor<32x16x1x1x32x32xf32>
  // CHECK-NEXT: %[[filt_relayout:.*]] = linalgx.relayout
  // CHECK-NEXT: %[[out:.*]] = tensor.empty() : tensor<14x32x28x28x32xf32>
