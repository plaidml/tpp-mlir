...
// CHECK-DAG: func.func private @xsmm_brgemm_dispatch_f32(i64, i64, i64, i64, i64, i64) -> i64 attributes {llvm.emit_c_interface}
// CHECK-DAG: func.func private @xsmm_brgemm_invoke_f32(i64, memref<f32>, index, index, index, index, index, index, index, memref<f32>, index, index, index, index, index, index, index, memref<f32>, index, index, index, index, index, i64) attributes {llvm.emit_c_interface}
