...
func.func @matmul_static(%arg0: tensor<256x512xbf16>, %arg1: tensor<512x1024xbf16>, %arg2: tensor<256x1024xbf16>) -> tensor<256x1024xbf16> {
  ...
  // CHECK: tpp.vnni_matmul ins(%{{.+}} : memref<256x512xbf16>, %{{.+}} : memref<256x1024x2xbf16>) outs(%{{.+}} : memref<256x1024xbf16>)
  %2 = vnni.matmul ins(%arg0 : tensor<256x512xbf16>, %1 : tensor<256x1024x2xbf16>) outs(%arg2 : tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
...
func.func @brgemm_static(%arg0: tensor<4x256x512xbf16>, %arg1: tensor<4x512x1024xbf16>, %arg2: tensor<256x1024xbf16>) -> tensor<256x1024xbf16> {
  ...
  // CHECK: tpp.vnni_brgemm ins(%{{.+}} : memref<4x256x512xbf16>, %{{.+}} : memref<4x256x1024x2xbf16>) outs(%{{.+}} : memref<256x1024xbf16>)
