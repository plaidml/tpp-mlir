// RUN: tpp-opt %s linalg-ext-to-loops -convert-linalg-to-loops -convert-tpp-to-xsmm -convert-xsmm-to-func -convert-vector-to-scf -convert-scf-to-cf -lower-affine  -reconcile-unrealized-casts |\
// RUN: tpp-run \
...
//
  ...
  func.func @entry(%arg0:memref<128x256xbf16>, %arg2:memref<512xbf16>, %arg4:memref<1024xbf16>, %arg6:memref<2048xbf16>, %arg8:memref<1000xbf16>, %arg9:memref<128x1000xbf16>, %arg10:memref<128x2048xbf16>, %arg11:memref<128x1024xbf16>, %arg12:memref<128x512xbf16>){
