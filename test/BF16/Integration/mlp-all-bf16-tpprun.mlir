...
//
  ...
  func.func @entry(%arg0:memref<128x256xbf16>, %arg2:memref<512xbf16>, %arg4:memref<1024xbf16>, %arg6:memref<2048xbf16>, %arg8:memref<1000xbf16>, %arg9:memref<128x512xbf16>,  %arg10:memref<128x1024xbf16>, %arg11:memref<128x2048xbf16>, %arg12:memref<128x1000xbf16>) {
    ...
    tpp.vnni_matmul ins(%arg0 : memref<128x256xbf16>, %relayout_arg0 : memref<128x512x2xbf16>) outs(%arg9 : memref<128x512xbf16>)
    ...
    tpp.vnni_matmul ins(%arg9 : memref<128x512xbf16>, %relayout_arg12 : memref<256x1024x2xbf16>) outs(%arg10 : memref<128x1024xbf16>)
    ...
    tpp.vnni_matmul ins(%arg10 : memref<128x1024xbf16>, %relayout_arg11 : memref<512x2048x2xbf16>) outs(%arg11 : memref<128x2048xbf16>)
    ...
    tpp.vnni_matmul ins(%arg11 : memref<128x2048xbf16>, %relayout_arg10 : memref<1024x1000x2xbf16>) outs(%arg12 : memref<128x1000xbf16>)
