 ...
 module @predict_function {
  func.func @entry(){
    ...
    scf.for %arg4 = %c0 to %c4 step %c1 {
      ...
      %wt_alloc = memref.alloc():memref<32x4x4x2xbf16>
      linalgx.pack %subview inner_dims_pos=[0] inner_tiles=[2] into %wt_alloc : (memref<64x4x4xbf16, strided<[16, 4, 1], offset: ?>> memref<32x4x4x2xbf16>)
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        ...
        tpp.brgemm ins(%wt_alloc:memref<32x4x4x2xbf16>, %subview_3 : memref<64x4x4xbf16, strided<[16, 4, 1], offset: ?>>) out(%subview_4 : memref<4x4xbf16, strided<[4, 1], offset: ?>>)
        tpp.relu ins(%subview_4 : memref<4x4xbf16, strided<[4, 1], offset: ?>>) out(%subview_4 : memref<4x4xbf16, strided<[4, 1], offset: ?>>)
       ...
       //
       // CHECK:( ( 129, 129, 129, 129 ), ( 129, 129, 129, 129 ), ( 129, 129, 129, 129 ), ( 129, 129, 129, 129 ) )
       //
        vector.print %f1 : vector<4x4xf32>
      }
      memref.dealloc %wt_alloc: memref<32x4x4x2xbf16>
    }
