...
func.func @entry(){
  ...
  scf.for %arg4 = %c0 to %c4 step %c1 {
    ...
    scf.for %arg5 = %c0 to %c16 step %c1 {
      ...
      tpp.vnni_brgemm ins(%subview:memref<64x4x4xbf16, strided<[16, 4,1], offset:?>>, %subview_3 : memref<64x2x4x2xbf16, strided<[16, 8, 2, 1], offset: ?>>) out(%subview_4 : memref<4x4xbf16, strided<[4, 1], offset: ?>>)
