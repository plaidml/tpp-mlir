...
module @predict_function {
  func.func @entry(){
    ...
    tpp.relu outs(%arg12 : memref<128x512xbf16>)
    ...
    tpp.relu outs(%arg11 : memref<128x1024xbf16>)
    ...
    tpp.relu outs(%arg10 : memref<128x2048xbf16>)
    ...
    tpp.relu outs(%arg9 : memref<128x1000xbf16>)
    return
  }
}
