...
// CHECK: %[[matrixB:.+]] = tensor.pack %arg1 inner_dims_pos = [1] inner_tiles = [2] into %[[pack]] : tensor<32x4x4xbf16> -> tensor<32x2x4x2xbf16> 
// CHECK: %[[result:.+]] = vnni.brgemm ins(%arg0 : tensor<32x4x4xbf16>, %[[matrixB]] : tensor<32x2x4x2xbf16>) outs(%arg2 : tensor<4x4xbf16>) -> tensor<4x4xbf16>
