...
func.func @entry() {
  ...
  %v0 = vector.transfer_read %packed[%c0, %c0, %c0, %c0, %c0], %d1 : tensor<1x4x6x6x2xf32>, vector<1x4x6x6x2xf32>
  vector.print %v0 : vector<1x4x6x6x2xf32>
  ...
  %v1 = vector.transfer_read %unpacked[%c0, %c0, %c0, %c0], %d1 : tensor<1x6x6x8xf32>, vector<1x6x6x8xf32>
  vector.print %v1 : vector<1x6x6x8xf32>
