...
func.func private @generate_1D_source1(%init_source : tensor<32xf32>) -> tensor<32xf32> {
  %source = linalg.generic {
      indexing_maps = [affine_map<(d0) -> (d0)>],
      iterator_types = ["parallel"]}
...
func.func @entry() {
  ...
  %input_tensor1 = call @generate_1D_source1(%init_source1) : (tensor<32xf32>) -> (tensor<32xf32>)
  ...
  %init_source2 = tensor.empty() : tensor<2xf32>
  %input_tensor2 = call @generate_1D_source(%init_source) : (tensor<2xf32>) -> (tensor<2xf32>)
