...
// RUN: mlir-gen --kernel=args --bias --relu --batch=32 --layers=16,16,16,16 --tiles=4,4,4 --float-type=bf16| tpp-run --def-parallel  -e=entry -entry-point-result=void -seed 123 -print | FileCheck %s
