...
// CHECK: tpp.gemm ins(%[[ARG0]] : memref<128x256xf32>, %[[ARG1]] : memref<256x512xf32>, %[[ARG12]] : memref<128x512xf32>) outs(%[[ARG12]] : memref<128x512xf32>)
...
// CHECK: tpp.gemm ins(%[[ARG12]] : memref<128x512xf32>, %[[ARG3]] : memref<512x1024xf32>, %[[ARG11]] : memref<128x1024xf32>) outs(%[[ARG11]] : memref<128x1024xf32>)
...
// CHECK: tpp.gemm ins(%[[ARG11]] : memref<128x1024xf32>, %[[ARG5]] : memref<1024x2048xf32>, %[[ARG10]] : memref<128x2048xf32>) outs(%[[ARG10]] : memref<128x2048xf32>)
...
// CHECK: tpp.gemm ins(%[[ARG10]] : memref<128x2048xf32>, %[[ARG7]] : memref<2048x1000xf32>, %[[ARG9]] : memref<128x1000xf32>) outs(%[[ARG9]] : memref<128x1000xf32>)
