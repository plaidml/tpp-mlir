//RUN: tpp-opt --combine-xsmm-op-optimization %s --split-input-file | FileCheck %s
...
// CHECK: %[[ARG0:.*]]: memref<256x128xf32>) -> memref<256x512xf32> {
// CHECK-NOT: xsmm.fused_brgemm.dispatch
...
func.func @entry2(%arg0: memref<256x128xf32>) -> memref<256x512xf32>  {
 %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
  %c4 = arith.constant 4 : index
  %c1 = arith.constant 1 : index
...
func.func @entry3(%arg0: memref<256x128xf32>) -> memref<256x512xf32>  {
 %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
  %c4 = arith.constant 4 : index
  %c1 = arith.constant 1 : index
...
// -----
// CHECK-LABEL: func.func @entry4_bf16(
...
//bcast_col_in0 flag set on binary add
func.func @entry4_bf16(%arg0: memref<256x128xbf16>) -> memref<256x512xbf16>  {
  %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
  %c4 = arith.constant 4 : index
  %c1 = arith.constant 1 : index
...
// CHECK-LABEL: func.func @entry5_bf16(
// CHECK: %[[ARG0:.*]]: memref<256x128xbf16>) -> memref<256x512xbf16> {
// CHECK-NOT: xsmm.fused_brgemm.dispatch
// CHECK-NOT: xsmm.fused_brgemm
...
//bcast_col_in1 flag set on binary add 
func.func @entry5_bf16(%arg0: memref<256x128xbf16>) -> memref<256x512xbf16>  {
  %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
  %c4 = arith.constant 4 : index
  %c1 = arith.constant 1 : index
...
// CHECK-LABEL: func.func @entry6_bf16(
// CHECK: %[[ARG0:.*]]: memref<256x128xbf16>) -> memref<256x512xbf16> {
// CHECK-NOT: xsmm.fused_brgemm.dispatch
// CHECK-NOT: xsmm.fused_brgemm
...
//none flag set on binary add 
func.func @entry6_bf16(%arg0: memref<256x128xbf16>) -> memref<256x512xbf16>  {
  %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
  %c4 = arith.constant 4 : index
  %c1 = arith.constant 1 : index
