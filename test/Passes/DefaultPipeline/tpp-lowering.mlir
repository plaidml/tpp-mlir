// RUN: tpp-opt %s -tpp-lowering="linalg-to-xsmm=0" | FileCheck %s -check-prefix=XSMM
// RUN: tpp-opt %s -tpp-lowering="tpp-to-loops=1 linalg-to-xsmm=0" | FileCheck %s -check-prefix=LOOPS
