// RUN: tpp-opt %s -pack-matmul="block-factors=32,32,32" -propagate-pack-and-unpack -canonicalize -tile-consumer-and-fuse-producers="tile-sizes=1,1 use-for-all=false" -canonicalize -rewrite-to-brgemm | FileCheck %s
