...
#include "TPP/Dialect/Triton/IR/Types.h"

#include "TPP/Dialect/Triton/IR/AttrInterfaces.h.inc"
...
#include "TPP/Dialect/Triton/IR/Dialect.cpp.inc"
#include "TPP/Dialect/Triton/IR/TritonTypeInterfaces.cpp.inc"
...
void TritonDialect::initialize() {
  ...
  addOperations<
#define GET_OP_LIST
#include "TPP/Dialect/Triton/IR/Ops.cpp.inc"
      >();
