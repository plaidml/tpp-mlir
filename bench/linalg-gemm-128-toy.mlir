...
module @predict_function  {
  func.func @main(%arg0: tensor<128x256xf32>, %arg1: tensor<256x512xf32> {stdx.const}, %arg2: tensor<512xf32> {stdx.const}, %arg3: tensor<512x1024xf32> {stdx.const}, %arg4: tensor<1024xf32> {stdx.const}, %arg5: tensor<1024x2048xf32> {stdx.const}, %arg6: tensor<2048xf32> {stdx.const}, %arg7: tensor<2048x1000xf32> {stdx.const}, %arg8: tensor<1000xf32> {stdx.const}) -> tensor<128x1000xf32> {
    ...
    %13 = linalg.generic {indexing_maps = [#map0, #map1], iterator_types = ["parallel", "parallel"]} ins(%arg8 : tensor<1000xf32>) outs(%12 : tensor<128x1000xf32>) {
    ^bb0(%arg9: f32, %arg10: f32):  // no predecessors
      linalg.yield %arg9 : f32
    } -> tensor<128x1000xf32>
    ...
    %15 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%14 : tensor<128x1000xf32>) outs(%12 : tensor<128x1000xf32>) {
    ^bb0(%arg9: f32, %arg10: f32):  // no predecessors
      %16 = mathx.relu %arg9 : f32 
      linalg.yield %16 : f32
    } -> tensor<128x1000xf32>
