...
// 2*128x768x768 + 128x768 + 128x768 = 151191552
// BENCH_TOTAL_FLOPS: 151191552
...
!A = tensor<4x12x32x64xbf16>
!B = tensor<12x12x32x64x2xbf16>
!C = tensor<4x12x32x64xbf16>

// GEMM packed with tile size: 32, 64, 64
