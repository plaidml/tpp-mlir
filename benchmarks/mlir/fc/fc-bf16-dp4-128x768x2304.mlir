...
// 2*128x768x2304 + 128x768 + 128x768 = 453181440
// BENCH_TOTAL_FLOPS: 453181440
...
!A = tensor<2x36x64x64xbf16>
!B = tensor<16x36x16x48x4xbf16>
!C = tensor<2x16x64x48xbf16>

// GEMM packed with tile size: 64, 48, 64
